            ...
            <form method='post' name='FeedSyndicateFeedsEditForm' id='FeedSyndicateFeedsEditForm' action='#'>
                ...
                <table cellspacing="2" cellpadding="5" class="form-table edit-form-table">
                    <tbody>
                        ...
                        <tr>
                            <td width="80"><Strong>Auto Publish: </Strong></td>
                            <td colspan="2">
                                <select id="edit_form_feed_publish">
                                    <option value="no">Do Not Auto Publish</option>
                                    <option value="draft">Publish as Draft</option>
                                    <option value="publish" selected="1">Auto Publish</option>
                                </select>
                            </td>
                        </tr>
                        <tr>
                            <td width="80" valign="top"><strong>Auto Publish Interval: </strong></td>
                            <td colspan="2">
                                <select id="edit_form_feed_cron">
                                    ...
                                    foreach (wp_get_schedules() as $key => $value) {
                                        ...
                                        if (isset($explode[2])) {
                                            switch ($explode[2]) {
                                                case "fs":
                                                    ?><option name="form_feed_cron" value="<?php echo $key ?>"><?php echo $value["display"] ?></option><?php
                                                    break;
                                            }
                                        }
                                    }
