<div id='tabs'>
    ...
    <div id='tabs-1'>
		<?php
		if(isset($_SESSION['edit_feed']) && $_SESSION['edit_feed'] == 1){ ?>
				...
				<table cellspacing="2" cellpadding="5" class="form-table edit-form-table">
					<tbody>
						...
						<tr>
							...
							<td colspan="2"><?php wp_dropdown_categories('hide_empty=0&id=edit_form_cat'); ?>
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td colspan="2">
							<input type="radio" name="edit_form_feed_cron" value="never" />&nbsp;Never<br/>
							<?php foreach (wp_get_schedules() as $name => $data) { ?>
							<input type="radio" name="edit_form_feed_cron" value="<?php echo esc_attr($name); ?>"/>&nbsp;<?php echo esc_html($data['display']); ?><br/>
							<?php } ?>
	...
	<div id='tabs-2'>
		<?php
		if(isset($_SESSION['add_new_feed']) && $_SESSION['add_new_feed'] == 1){ ?>
