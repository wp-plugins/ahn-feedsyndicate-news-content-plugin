...
= 3.6.8 =
* New cron intervals
* Display only relevant time intervals in dropdown box
* Fixed a bug where featured image wasn't set
* Improved security of submitted forms
* Improved flexibility in how posts are published

= 3.6.7 =
* Fixed session related error on PHP below 5.4.0
* Removes all cron schedules on plugin deactivation and restores them on activation
* Major overhaul of XML parser
* Fixed error "The plugin generated xxx characters of unexpected output" during activation
* Fixed incompatibility with PHP version before 5.5
* Fixed issue where incorrect number of published posts is displayed when publishing all feeds
